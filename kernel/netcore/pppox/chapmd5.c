 ...
 */
void
_chapMD5Init (MD5_CTX *mdContext)
{
 ...
 */
void
_chapMD5Update(MD5_CTX *mdContext, unsigned char *inBuf, unsigned int inLen)
{
  u32_t in[16];
  int mdi;
  unsigned int i, ii;
 ...
 */
void
_chapMD5Final (unsigned char hash[], MD5_CTX *mdContext)
{
  u32_t in[16];
  int mdi;
  unsigned int i, ii;
  ...
  _chapMD5Update (mdContext, PADDING, padLen);
